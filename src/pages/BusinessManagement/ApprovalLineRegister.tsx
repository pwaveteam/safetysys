...
const { validateForm, isFieldInvalid, clearErrors } = useForm(validationRules)
...
<Tag>{approver}</Tag>
{idx < selectedApprovers.length - 1 && <ChevronRight size={14} className="text-gray-400 mx-1.5" />}
</span>
))}
</div>
)
