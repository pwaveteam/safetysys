    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg w-[90%] max-w-sm mx-4">
        ...
        <div className="flex gap-2 p-3 border-t border-gray-200">
          <button onClick={() => fileInputRef.current?.click()} className="flex-1 py-2 rounded-lg border border-gray-300 text-gray-600 text-xs font-medium flex items-center justify-center gap-1">
            <Upload size={14} />불러오기
          </button>
